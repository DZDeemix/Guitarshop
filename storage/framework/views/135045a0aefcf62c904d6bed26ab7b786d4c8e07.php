...
<head>
    ...
    <?php echo $__env->yieldContent('Meta_property'); ?>
    <!-- Favicon-->
            ...
            <div class="container">
                <div class="main-nav-wrapper">
                    ...
                    <div class="header-right-search">
                        ...
                        <div class="search-button-wrapper header-customize-item style-default">
                            <form action="<?php echo e(route('search')); ?>" autocomplete="off">
                                <div class="<?php echo e($errors->has('s') ? 'has-error' : ''); ?>">
                                    <input type="text"   name="s" placeholder="<?php echo e($errors->has('s') ? 'поле обязательно' : 'найти'); ?>">
...
<?php echo $__env->yieldContent('create-order'); ?>
