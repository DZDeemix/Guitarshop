                            ...
                            <div class="single-product-slider">
                                ...
                                <div id="sync1" class="owl-carousel owl-template">
                                    <?php if($product->cover): ?>
                                        <div class="item">
                                            <figure><img src="/images/cover_products/<?php echo e($product->cover); ?>" alt="slide" width="1080" height="768"/></figure>
                                        </div>
                                    <?php endif; ?>
                                    <?php if($product->gallery): ?>
                                        <?php $__currentLoopData = $product->gallery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="item">
                                                <figure><img src="/images/gallery_products/<?php echo e($item->src_path); ?>" alt="slide" width="1080" height="768"/></figure>
                                            </div>
