    ...
    <header class="header yolo-header-style-8">
        ...
        <div class="mobile-menu">
            ...
            <div class="col-3 text-center">
                <div class="logo">
                    <h1><a href="<?php echo e(route ('main')); ?>"><img src="/Site/images/logo/logo_pvb3.svg" alt="logo"/></a></h1>
                </div>
            </div>
                                ...
                                <article class="recent_news_item">
                                    <div class="post-meta">
                                        <div class="post-meta-inner">
                                            <span class="post-day"><?php echo e(date("d", strtotime ($item->created_at))); ?> </span>
                                            <span class="post-month"><?php echo e(config('GS.month')[(date("n", strtotime ($item->created_at))-1)]); ?> </span>
                                        </div>
                                    </div>
                                    <div class="post-thumbnail">
                                        <a href="<?php echo e(route('post_show',['alias' => $item->alias])); ?>">
                                            <div class="absolute-center absolute-center-posts-main" style="background-image: url( '<?php echo e('/images/coves_posts/' . $item->cover); ?>' );">
                                        ...
                                        <div class="post-content">
                                            <div class="post-main-content">
                                                <h4 class="entry-title">
                                                    <a href="<?php echo e(route('post_show',['alias' => $item->alias])); ?>"><?php echo e($item->title); ?></a>
                                                </h4>

                                                <p class="post-excerpt"><?php echo substr(strip_tags($item->content),0,100) . "..."; ?></p>
