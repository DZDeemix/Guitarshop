                ...
                <div class="entry-thumbnail-wrap">
                    <div class="data-post-meta">
                        <div class="post-meta-inner">
                            <span class="post-day"><?php echo e(date("d", strtotime ($item->created_utc))); ?> </span>
                            <span class="post-month"><?php echo e(config('GS.month')[(date("n", strtotime ($item->created_utc))-1)]); ?> </span>
                        </div>
                    </div>
                    <div>
                        <a href="<?php echo e(route('post_show',['alias' => $item->alias])); ?>" >
                        <div  class="absolute-center absolute-center-posts img-responsive" style="background-image: url( '<?php echo e('/images/coves_posts/' . $item->cover); ?>')" >
                        </div>
                        </a>
