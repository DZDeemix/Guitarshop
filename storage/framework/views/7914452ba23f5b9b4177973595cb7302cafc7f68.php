        ...
        <ul class="nav navbar-top-links navbar-right">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-user">
                    ...
                    <li class="divider"></li>
                    <li><a href="<?php echo e(route('logout')); ?>"><i class="fa fa-sign-out fa-fw"></i> Выйти</a>
                    </li>
                </ul>
                <!-- /.dropdown-user -->
            </li>
            ...
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="<?php echo e(route('admin_show_page', ['id' => 1])); ?>"><i class="fa fa-wrench fa-fw"></i>Главная</a>
                            </li>
                            <li>
                                <a href="<?php echo e(route('admin_show_page', ['id' => 2])); ?>"><i class="fa fa-wrench fa-fw"></i>Страница товаров</a>
                            </li>
                            <li>
                                <a href="<?php echo e(route('admin_show_page', ['id' => 3])); ?>"><i class="fa fa-wrench fa-fw"></i>Страница постов</a>
                            </li>
                            <li>
                                <a href="<?php echo e(route('admin_show_page', ['id' => 4])); ?>"><i class="fa fa-wrench fa-fw"></i>Страница о нас</a>
                            </li>
                            <li>
                                <a href="<?php echo e(route('admin_show_page', ['id' => 5])); ?>"><i class="fa fa-wrench fa-fw"></i>Страница поиска</a>
                            </li>
...
<?php echo $__env->yieldPushContent('foter_script'); ?>
