...
class SettingsRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        $rules = [
            'paginatoin_admin'=> 'required|numeric',
            'paginatoin_site'=> 'required|numeric',
            'paginatoin_site_onMain' => 'required|numeric',
            'email' => 'required|string|max:255',
            'paginatoin_admin_product' => 'required|numeric',
            'paginatoin_site_product' => 'required|numeric',
            'email_send1' => 'required|string|max:255',
            'paginatoin_site_onMain_products' => 'required|numeric',
